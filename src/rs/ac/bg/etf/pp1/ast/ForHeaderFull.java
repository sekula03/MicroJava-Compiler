...
public class ForHeaderFull extends ForHeader {

    private DesignatorStatement DesignatorStatement;
    private Condition Condition;
    private DesignatorStatement DesignatorStatement1;

    public ForHeaderFull (DesignatorStatement DesignatorStatement, Condition Condition, DesignatorStatement DesignatorStatement1) {
