...
public class ConditionFactGreater extends ConditionFact {

    private ArithmeticExpression ArithmeticExpression;
    private ArithmeticExpression ArithmeticExpression1;

    public ConditionFactGreater (ArithmeticExpression ArithmeticExpression, ArithmeticExpression ArithmeticExpression1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionFactGreater(\n");
