...
public class ConditionFactNotEqual extends ConditionFact {

    private ArithmeticExpression ArithmeticExpression;
    private ArithmeticExpression ArithmeticExpression1;

    public ConditionFactNotEqual (ArithmeticExpression ArithmeticExpression, ArithmeticExpression ArithmeticExpression1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionFactNotEqual(\n");
