...
public class ConditionFactEqual extends ConditionFact {

    private ArithmeticExpression ArithmeticExpression;
    private ArithmeticExpression ArithmeticExpression1;

    public ConditionFactEqual (ArithmeticExpression ArithmeticExpression, ArithmeticExpression ArithmeticExpression1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionFactEqual(\n");
