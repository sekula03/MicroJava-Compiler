...
public class ConditionFactLess extends ConditionFact {

    private ArithmeticExpression ArithmeticExpression;
    private ArithmeticExpression ArithmeticExpression1;

    public ConditionFactLess (ArithmeticExpression ArithmeticExpression, ArithmeticExpression ArithmeticExpression1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionFactLess(\n");
