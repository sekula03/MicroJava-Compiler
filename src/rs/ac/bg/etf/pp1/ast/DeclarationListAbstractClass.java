...
public class DeclarationListAbstractClass extends DeclarationList {

    private DeclarationList DeclarationList;
    private AbstractClassDeclaration AbstractClassDeclaration;

    public DeclarationListAbstractClass (DeclarationList DeclarationList, AbstractClassDeclaration AbstractClassDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationListAbstractClass(\n");
