...
public class MethodDeclarationListMore extends MethodDeclarationList {

    private MethodDeclarationList MethodDeclarationList;
    private MethodDeclaration MethodDeclaration;

    public MethodDeclarationListMore (MethodDeclarationList MethodDeclarationList, MethodDeclaration MethodDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDeclarationListMore(\n");
