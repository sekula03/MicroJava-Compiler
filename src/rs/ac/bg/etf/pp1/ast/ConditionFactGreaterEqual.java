...
public class ConditionFactGreaterEqual extends ConditionFact {

    private ArithmeticExpression ArithmeticExpression;
    private ArithmeticExpression ArithmeticExpression1;

    public ConditionFactGreaterEqual (ArithmeticExpression ArithmeticExpression, ArithmeticExpression ArithmeticExpression1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionFactGreaterEqual(\n");
